...
# --------------------------------------------------------------------------------------------------------------- #
#### Final Table ####
EUR <- cbind(fin_EUR, ph_EUR, feed_EUR, locomotion_EUR, resp_EUR, size_EUR, volt_EUR, rep_EUR, temp_EUR)
NAM <- cbind(fin_NAM, ph_NAM, feed_NAM, locomotion_NAM, resp_NAM, size_NAM, volt_NAM, rep_NAM, temp_NAM)
AUS <- cbind(fin_AUS, ph_AUS, feed_AUS, locomotion_AUS, resp_AUS, size_AUS, volt_AUS, rep_AUS, temp_AUS)
